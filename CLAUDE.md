...
| Notebook opcional de buckets Waymo (Motion / E2E / v1) | ✅ `14_opcional_waymo_buckets`: lote liviano + tablas chicas (cajas 2D, pose, calibración) traducidas a nombres de clase; v1/Motion/video se listan, no se bajan. Guía: `docs/productos_waymo.md` |
| EFT | ⏳ pendiente |
