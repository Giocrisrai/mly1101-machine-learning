...
1. Guion de sala de EP2 y EP3 (la plantilla 15 cubre la carga; el modelado se traslada de las Act. 2.2–3.3).
2. No copiar el notebook institucional Telco al GitHub público.
